...
async function getEmployeeSchedule() {
    ...
    let details = await bus.getEmployeeShifts(empId)
    console.log('\n')
...
async function displayEmployees() {
    let employees = await bus.getAllEmployees()
...
async function scheduleEmployee() {
    ...
    let result = await bus.assignShift(empId, shiftId)
    if (result === 'Ok') {
